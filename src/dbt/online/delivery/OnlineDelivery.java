...
public class OnlineDelivery {
	...
	public void firstTest(){
		...
		Customer customer1 = new Customer("Hans M�ller", "Hamburg", "robot@gmail.com");
		Customer customer2 = new Customer("Herbert Sch�fer", "Hamburg", "robot@gmail.com");
		...
		Ingredient i3 = new Ingredient(3, "K�se");
		...
		Menu sp6 = new Menu("Getr�nk Cola", 1);
		sp6.addProduct(s2);		
		Menu sp7 = new Menu("Getr�nk Sprite", 0);
		sp7.addProduct(s1);
